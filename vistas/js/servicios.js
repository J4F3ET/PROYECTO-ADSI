    ...
    el.addEventListener("mouseover", e => {
      ...
      switch (id) {
        case 'serv_1_diag':
          ...
          document.getElementById('figura_img_servicios').innerHTML='<img width="85%" id="imagen-de-opciones" src="vistas/img/img_servicios/1.jpeg" alt="Servicios de la empresa">';
          break;
        case 'serv_2_sistem':
          ...
          document.getElementById('figura_img_servicios').innerHTML='<img width="85%" id="imagen-de-opciones" src="vistas/img/img_servicios/2.jpeg" alt="Servicios de la empresa">';
          break;
        case 'serv_3_suministro':
          ...
          document.getElementById('figura_img_servicios').innerHTML='<img width="85%"  id="imagen-de-opciones" src="vistas/img/img_servicios/3.jpeg" alt="Servicios de la empresa">';
          break;
        case 'serv_4_scanner':
          ...
          document.getElementById('figura_img_servicios').innerHTML='<img width="85%" id="imagen-de-opciones" src="vistas/img/img_servicios/4.jpeg" alt="Servicios de la empresa">';
          break;
        case 'serv_5_mantenimiento':
          ...
          document.getElementById('figura_img_servicios').innerHTML='<img width="85%" id="imagen-de-opciones" src="vistas/img/img_servicios/5.jpeg" alt="Servicios de la empresa">';
          break;
        case 'serv_6_Cambio':
          ...
          document.getElementById('figura_img_servicios').innerHTML='<img width="85%" id="imagen-de-opciones" src="vistas/img/img_servicios/6.jpeg" alt="Servicios de la empresa">';
          break;
        case 'serv_7_mantenimiento_electronico':
          ...
          document.getElementById('figura_img_servicios').innerHTML='<img width="85%" id="imagen-de-opciones" src="vistas/img/img_servicios/7.jpeg" alt="Servicios de la empresa">';
          break;
        case 'serv_8_mantenimiento_radiador':
          ...
          document.getElementById('figura_img_servicios').innerHTML='<img width="85%" id="imagen-de-opciones" src="vistas/img/img_servicios/8.jpeg" alt="Servicios de la empresa">';
          break;
        case 'serv_9_bombas':
          ...
          document.getElementById('figura_img_servicios').innerHTML='<img width="85%" id="imagen-de-opciones" src="vistas/img/img_servicios/9.jpeg" alt="Servicios de la empresa">';
          break;
        default:
          document.getElementById('parrafo_servicios').innerHTML= 'En ServiDieselFL.SAS tenemos un catalogo variado de servicios para nuestros clientes.<br>Porfavor selecione alguno de las opciones del panel izquierdo. Gracias<br><br>En el caso de los celulares el panel se ubica en la parte supérior de este panel. Gracias por su atención.';
          document.getElementById('figura_img_servicios').innerHTML='<img  id="imgServicios" class="img-responsive img-rounded media-middle media-top  media-right" src="vistas/img/img_servicios/1.jpeg" alt="Servicios de la empresa">';
          break;
      }
    });
  });
